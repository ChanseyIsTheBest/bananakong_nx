...
// Point every ABS64/GLOB_DAT/JUMP_SLOT relocation that names `symbol` (defined
// or not) at `addr`. Must run after so_relocate/so_resolve and before
// so_finalize. Returns the number of slots rewritten.
